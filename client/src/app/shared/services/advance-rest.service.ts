...
export class AdvanceRestService {
  ...
  index<T>(_params?: { [key: string]: any; }, _action?: string) {
    const opts = this.globalService.getHttpOptions();
    let action = '';
    if (_params !== undefined) { opts['params'] = _params; }
    if (_action !== undefined && _action !== '') { action = _action; }
  ...
  create<T>(_params?: { [key: string]: any; }, _action?: string) {
    const opts = this.globalService.getHttpOptions();
    let action = 'create';
    if (_params !== undefined) { opts['params'] = _params; }
    if (_action !== undefined && _action !== '') { action = _action; }
  ...
  edit<T>(_id, _params?: { [key: string]: any; }, _action?: string) {
    const opts = this.globalService.getHttpOptions();
    let action = 'edit';
    if (_params !== undefined) { opts['params'] = _params; }
    if (_action !== undefined && _action !== '') { action = _action; }
  ...
  save<T>(_data: { [key: string]: any; }, _params?: { [key: string]: any; }, _action?: string) {
    const opts = this.globalService.getHttpOptions();
    const data = _data;
    let action = 'save';
    if (_params !== undefined) { opts['params'] = _params; }
  ...
  delete<T>(_id, _params?: { [key: string]: any; }, _action?: string) {
    const opts = this.globalService.getHttpOptions();
    let action = 'delete';
    if (_params !== undefined) { opts['params'] = _params; }
    if (_action !== undefined && _action !== '') { action = _action; }
